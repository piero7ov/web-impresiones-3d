<?php
/**
 * GESTIÓN DE CONTACTOS: contactos.php
 * Finalidad: Listar, leer y eliminar mensajes recibidos por el formulario de contacto.
 * Incluye protección contra borrados accidentales y validación CSRF.
 */
