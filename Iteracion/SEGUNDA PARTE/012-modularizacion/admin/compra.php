<?php
/**
 * FICHA DE COMPRA: compra.php
 * Finalidad: Mostrar los detalles de una compra y permitir cambiar su estado.
 * Cruza datos con clientes.json para mostrar información del comprador.
 */
  ...
  if (!hash_equals($csrf, $token)) {
    ...
    if (!$updated) {
      ...
      if ($json === false) {
        ...
        if ($ok === false) {
          $saveErrMsg = "No se pudo guardar. Inténtelo más tarde.";
        } else {
      ...
      <section class="detail-grid">
        ...
        <div class="admin-card">
          ...
          <?php elseif ($cliente === null): ?>
            <p class="muted">No se pudo localizar el registro de cliente asociado.</p>
