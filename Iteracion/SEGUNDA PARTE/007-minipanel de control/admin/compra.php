  ...
  <main class="admin">
    ...
    <?php else: ?>
      <?php
        ...
        $prodNombre = (string)get_field($found, ["product_name","producto.nombre","producto.name","product.nombre","product.name"], "—");
        $prodMaterial = (string)get_field($found, ["material","producto.material","product.material"], "—");
        $prodTamano = (string)get_field($found, ["tamano","producto.tamano","producto.size","product.size"], "—");
        $prodCategoria = (string)get_field($found, ["categoria","producto.categoria","product.categoria"], "—");
        $precioUnit = get_field($found, ["precio_unit","producto.precio_unit","producto.price_unit","product.price_unit"], "");
        $qty = (int)get_field($found, ["qty","producto.qty","product.qty"], 1);
        $color = (string)get_field($found, ["color","producto.color","product.color"], "—");
        $total = get_field($found, ["total","producto.total","product.total"], "");
      ?>
