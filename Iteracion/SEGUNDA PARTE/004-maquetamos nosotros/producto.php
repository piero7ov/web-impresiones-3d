...
<head>
  ...
  <style>
    ...
    /* Que el main se vea “de ficha” */
    main{
      max-width: 1200px;
      align-items: center;
    }

    /* Tarjeta más grande para ocupar mejor el espacio */
    .product-card{
      flex-basis: 100%;
      max-width: 1100px;
      margin: 10px auto;
    ...
    .product-card .destacado-inner{
      align-items: center;
      min-height: 520px; /* ayuda a que el bloque sea alto y no se vea vacío */
    }
    ...
    .color-pill{
      ...
      user-select: none;
      position: relative;
      padding: 4px 6px; /* un pelín de aire */
      border-radius: 10px;
    }
    ...
    /* ✅ Botones fuera del box (más aire) */
    .actions-row{
      display: flex;
      gap: 12px;
      flex-wrap: wrap;
