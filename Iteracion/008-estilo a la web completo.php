...
<head>
    ...
    main {
        ...
        max-width: 1200px;
        margin: 0 auto;
        align-items: stretch; /* todas las tarjetas misma altura en la fila */
    }
    ...
    main article {
        ...
        /* NUEVO: para poder fijar el bloque precio+botón al fondo */
        display: flex;
    ...
    /* BLOQUE PRECIO + BOTÓN ALINEADO ABAJO SIEMPRE */
    .product-price-cta {
        display: flex;
    ...
    /* Producto 1: tarjeta principal grande */
    main article:nth-child(1) {
        flex-basis: 100%;
    }

    /* Productos 2 y 3: dos tarjetas anchas */
    main article:nth-child(2),
    main article:nth-child(3) {
        flex-basis: calc(50% - 20px);
    }

    /* Productos 4–7: cuatro columnas */
